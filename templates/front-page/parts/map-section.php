  ...
  <div class="map-section__container content-container">
    ...
    <div class="map-section__content">
      <div class="map-section__left">
        <h2 class="map-section__title">Our clients praise us for <span>fast communication and service</span></h2>
        <div class="map-section__text">In addition, <span>our location</span> in Dubai allows us to deeply understand the ins and outs of the process of starting a business in the UAE</div>

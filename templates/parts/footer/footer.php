  ...
  <div class="content-container footer__container">
    <div class="footer__col">
      ...
      <div class="footer__socials">
        <a class="footer__socials-link link-round-hover" href="<?= Contacts::get_inst_url() ?>" rel="nofollow noopener noreferrer">
        ...
        <a class="footer__socials-link link-round-hover" href="<?= Contacts::get_tg_url() ?>" rel="nofollow noopener noreferrer">
        ...
        <a class="footer__socials-link link-round-hover" href="<?= Contacts::get_yt_url() ?>" rel="nofollow noopener noreferrer">
        ...
        <a class="footer__socials-link link-round-hover" href="<?= Contacts::get_fb_url() ?>" rel="nofollow noopener noreferrer">
    ...
    <div class="footer__col">
      <div class="footer__contacts">
        ...
        <div class="footer__socials-block">
          <a class="footer__socials-link link-round-hover" href="<?= Contacts::get_wa_url() ?>" rel="nofollow noopener noreferrer">

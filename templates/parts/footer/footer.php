  ...
  <div class="content-container footer__container">
    <div class="footer__col">
      ...
      <div class="footer__socials">
        <a class="footer__socials-link" href="<?= Contacts::get_inst_url() ?>">
        ...
        <a class="footer__socials-link" href="<?= Contacts::get_tg_url() ?>">
        ...
        <a class="footer__socials-link" href="<?= Contacts::get_yt_url() ?>">
        ...
        <a class="footer__socials-link" href="<?= Contacts::get_fb_url() ?>">
        ...
        <a class="footer__socials-email" href="mailto:<?= Contacts::get_main_mail() ?>"><?= Contacts::get_main_mail() ?></a>
      </div>
    </div>
    ...
    <div class="footer__col">
      ...
      <ul class="list-reset footer__nav">
        <li class="footer__nav-item">
          <a class="footer__nav-link" href="#">Accounting support</a>
        </li>
        <li class="footer__nav-item">
          <a class="footer__nav-link" href="#">VAT TRN registration (VAT)</a>
        </li>
        <li class="footer__nav-item">
          <a class="footer__nav-link" href="#">Corporate tax</a>
        </li>
      </ul>
    </div>
    ...
    <div class="footer__col">
      ...
      <ul class="list-reset footer__nav">
        <li class="footer__nav-item">
          <a class="footer__nav-link" href="#">Opening a company in the Free Zone</a>
        </li>
        <li class="footer__nav-item">
          <a class="footer__nav-link" href="#">Opening a company in Mainland</a>
        </li>
        <li class="footer__nav-item">
          <a class="footer__nav-link" href="#">Opening a freelance license</a>
        </li>
        <li class="footer__nav-item">
          <a class="footer__nav-link" href="#">Obtaining a resident visa</a>
        </li>
        <li class="footer__nav-item">
          <a class="footer__nav-link" href="#">Opening a bank account</a>
        </li>
      </ul>
    </div>
      ...
      <div class="footer__contacts">
        ...
        <div class="footer__phone">
          <img loading="lazy" src="<?= ct()->get_assets_url() ?>/img/dub-flag.png" class="footer__phone-flag" width="30"
            height="15" alt="">
          <a class="footer__phone-link" href="tel:<?= Contacts::get_main_phone()['formated'] ?>"><?= Contacts::get_main_phone()['raw'] ?></a>
        </div>
        <div class="footer__socials-block">
          <a class="footer__socials-link" href="<?= Contacts::get_wa_url() ?>">
